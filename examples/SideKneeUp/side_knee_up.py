...
while True:
    ...
    if len(pose_lmList) != 0:
        if pose_lmList[11][1] > pose_lmList[12][1]:
            ...
            cv2.putText(img, str(int(right_arm_angle)), (x+40,y+30), cv2.FONT_HERSHEY_PLAIN, 2, (0,0,255), 2)
